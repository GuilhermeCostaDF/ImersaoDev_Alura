...
var cartaRafa = {
    nome: "Bulbasauro",
    imagem: "https://cdn.bulbagarden.net/upload/thumb/1/19/Ash_Bulbasaur.png/1200px-Ash_Bulbasaur.png",
    atributos: {
        ataque: 70,
        defesa: 65,
        magia: 85
...
function jogar() {
    ...
    if(cartas.length == 0){
        alert("FIIIIIIM DE PAAAPO")
        if(pontosJogador>pontosMaquina){
            htmlResultado='<p class="resultado-final">Congraaaatsss...Você venceeu!!!</p>'
        }
        else if(pontosMaquina>pontosJogador){
            htmlResultado='<p class="resultado-final">Afff.....Você perdeu :x</p>'
        }
        else{
            htmlResultado='<p class="resultado-final">meeeeh...Empatou</p>'
        }
    }
